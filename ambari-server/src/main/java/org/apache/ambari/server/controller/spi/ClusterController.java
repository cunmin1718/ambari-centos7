...
public interface ClusterController extends SchemaFactory {
   ...
   */
  QueryResponse getResources(Type type, Request request, Predicate predicate)
   ...
   */
  Set<Resource> populateResources(Type type,
   ...
   * @throws NoSuchParentResourceException a specified parent resource doesn't exist
   */
  Iterable<Resource> getIterable(Type type, QueryResponse queryResponse,
   ...
   * @throws NoSuchParentResourceException a specified parent resource doesn't exist
   */
  PageResponse getPage(Type type, QueryResponse queryResponse,
                       Request request, Predicate predicate,
   ...
   */
  ResourceProvider ensureResourceProvider(Type type);
   ...
   * @throws NoSuchParentResourceException a specified parent resource doesn't exist
   */
  RequestStatus createResources(Type type, Request request)
      throws UnsupportedPropertyException,
             SystemException,
   ...
   * @throws NoSuchParentResourceException a specified parent resource doesn't exist
   */
  RequestStatus updateResources(Type type,
                                Request request,
                                Predicate predicate)
      throws UnsupportedPropertyException,
             SystemException,
   ...
   * @throws NoSuchParentResourceException a specified parent resource doesn't exist
   */
  RequestStatus deleteResources(Type type,
                                Request request,
                                Predicate predicate)
      throws UnsupportedPropertyException,
             SystemException,
